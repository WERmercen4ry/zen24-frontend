    ...
    return (
        <Container className="workout-history mt-2 card-content">
                ...
                <div className="p-3 package-card child-content">
                    <Row>
                        <Col md="9"  xs="7">
                            ...
                            <p className='mb-1 text-muted'>Số buổi tập: {packageInfo.attendedSessions}/{packageInfo.totalSessions}</p>
                        ...
                        <Col md="3" xs="5" className=" align-items-center">
                            <div className='d-flex justify-content-center '><img src={packageInfo.logo} width="80" alt="logo" className="package-logo" /></div>
            ...
            <div className="d-flex align-items-center justify-content-center">
                ...
                <Input className='input-date selected-date' type="date" name="filterDate" id="filterDate" />
            </div>
                    ...
                    <Row key={index} className="workout-item mb-2 justify-content-center">
                        ...
                        <Row className='p-0 m-1'>
                            ...
                            <Col xs="12" className='mt-1'>
                                <Row >
                                    <Col md="1" xs="2">
                                        <img src={session.trainerImg} alt="trainer" className="trainer-img" />
                                    </Col>
                                    ...
                                    <Col md="2" xs="5" className="d-flex align-items-center justify-content-end">
                                        <Button color="primary" size="lg" className="status-btn">Đặt lịch</Button>
                                    </Col>
                                </Row>
                            </Col>
